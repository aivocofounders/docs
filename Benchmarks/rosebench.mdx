---
title: "Open Source S2S Benchmark "
description: "An open-source benchmarking and evaluation framework for Speech-to-Speech (S2S) AI models, designed by AIvoco to assess end-to-end model capabilities across latency, speech naturalness, response accuracy, memory retention, and conversational fluidity. The framework enables researchers and developers to measure real-world performance of speech interaction systems using standardized datasets, metrics, and reproducible evaluation pipelines."
---
...
Our model **Rose (Aivoco v1)** was evaluated on **open-source benchmarks** — available on [GitHub](https://github.com/aivocofounders/sts-bench).  
You can **evaluate our benchmarks** and **fact-check our model’s performance** using the framework.
...
Access the opensource benchmarking framework at https://github.com/aivocofounders/sts-bench

### Vispark Models Integration

This framework leverages **Vispark's cutting-edge AI models** available at https://lab.vispark.in:
...
**Measures:** Cold start time for initial response **Methodology:** Average of 100 sequential calls on same network/device
...
**Measures:** Response time during sustained 30-minute conversations **Methodology:** Average of 100 sessions with realistic interactions
...
**Measures:** Functional correctness of code generation via speech **Methodology:** HumanEval dataset processed through S2S pipeline
...
**Measures:** Accuracy of function call generation from voice commands **Methodology:** BFCL dataset with real function calling scenarios
...
**Measures:** Ability to convey and recognize emotions authentically **Methodology:** 8 core emotions over 100 interactions with AI judging
...
**Measures:** Speech naturalness across 15 languages (5 European + 10 Indian) **Methodology:** Conversational scenarios in native scripts
...
**Measures:** Vocal variety, intonation, and emotional expressiveness **Methodology:** 8 expressive scenarios with multimodal AI analysis
...
**Measures:** Moral reasoning and ethical decision-making **Methodology:** MM-NIAH dataset with multimodal evaluation
...
**Measures:** Alignment with positive AI behavior guidelines **Methodology:** HLE evaluation framework with voice interactions
...
**Key Metrics:** Average first response time **Best For:** Production deployment evaluation
...
**Key Metrics:** Average response time over 100 sessions **Best For:** Long conversation reliability testing
...
**Key Metrics:** Pass@k accuracy rates **Best For:** Programming assistant evaluation
...
**Key Metrics:** Function call accuracy, parameter extraction **Best For:** Voice-controlled application testing
...
**Key Metrics:** Emotional accuracy scores per emotion type **Best For:** Empathetic AI and emotional support applications
...
**Key Metrics:** Naturalness scores per language **Best For:** Multilingual application deployment
...
**Key Metrics:** Expressiveness scores, prosodic quality **Best For:** Entertainment and presentation applications
...
**Key Metrics:** Ethical accuracy, moral reasoning quality **Best For:** Safety-critical application evaluation
...
**Key Metrics:** HLE compliance scores **Best For:** Responsible AI deployment evaluation
...
**Last Updated:** August 30, 2025 **Framework Version:** v1.0 **Tested Models:** 4 major S2S models

---

This comprehensive benchmarking framework provides the most thorough evaluation of speech-to-speech AI models available, covering all critical aspects from technical performance to ethical alignment._